...
void gen_rand_points(double x1, double y1, double x2, double y2, std::vector<PointVDG>& point, unsigned int count);


int main(int argc, char* argv[])
{
   std::vector<PointVDG> point;
   std::vector<PointVDG> convex_hull;
   ...
   if (argc == 7)
   {
     ...
     */
     ...
     gen_rand_points(0,0,100,100,point,6);
