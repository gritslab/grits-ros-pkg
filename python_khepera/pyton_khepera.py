#!/usr/bin/env python
import roslib, rospy
roslib.load_manifest('YOUR_MODULE_NAME')
import sys
...
def SendControl(ContPublisher, control):
    ContMsg = khepera3_driver.msg.UnicycleControlInput()
...
rospy.init_node('gg_run')
#----------
#publish to
#----------
for i,a in enumerate(RO_ID):
    msg_name = '/K%d/khepera3_send_control' %a
    mControlPublisher[a] = rospy.Publisher(msg_name,
                                           khepera3_driver.msg.UnicycleControlInput,
                                           queue_size = 100)
#----------
#subscribe to
#----------
